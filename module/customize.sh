...
if [ -d /data/data/$DIALER ]; then
    ...
    if $VKSEL; then
        ...
        # echo "pixelify.gsm.operator.numeric=$CALL_SCREEN_NUM,$CALL_SCREEN_NUM" >>$MODPATH/system.prop
        # echo "pixelify.gsm.operator.iso-country=$CALL_SCREEN_CR,$CALL_SCREEN_CR" >>$MODPATH/system.prop
        # echo "pixelify.gsm.sim.operator.iso-country=$CALL_SCREEN_CR" >>$MODPATH/system.prop
        # echo "pixelify.gsm.sim.operator.numeric=$CALL_SCREEN_NUM" >>$MODPATH/system.prop
        # echo "pixelify.gsm.sim.state=LOADED,LOADED" >>$MODPATH/system.prop
        echo "ro.pixelify.callscreening.country=$lang" >>$MODPATH/system.prop
        setprop ro.pixelify.callscreening.country $lang
...
db_edit $gms com.google.android.platform.privacy boolVal 1 "location_accuracy_enabled" "com.google.android.platform.privacy" "permissions_hub_enabled" "privacy_dashboard_7_day_toggle"
