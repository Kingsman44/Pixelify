...
static std::vector<std::string> P7 = {"com.google.android.inputmethod.latin", "com.google.android.apps.subscriptions.red", "com.google.android.apps.recorder", "com.google.android.apps.wellbeing"};
static std::vector<std::string> keep = {"com.google.android.GoogleCamera", "com.google.ar.core", "com.google.vr.apps.ornament", "com.google.android.youtube", "com.google.android.apps.motionsense.bridge", "com.google.android.xx"};
...
private:
    ...
    void preSpecialize(const char *process)
    {
        ...
        {
            injectBuild(process, "Pixel 7 Pro", "raven", "google/raven/raven:13/TP1A.220624.021/8877034:user/release-keys");
        }
